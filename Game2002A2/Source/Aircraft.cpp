...
Aircraft::Aircraft(Type type, const TextureHolder& textures, const FontHolder& fonts, int x)
...
, mMissileDisplay(nullptr)
{
	...
	{
		createProjectile(node, Projectile::Laser, -0.5f, 0.2f, textures);
		createProjectile(node, Projectile::Laser, -0.25f, 0.3f, textures);
...
void Aircraft::createBullets(SceneNode& node, const TextureHolder& textures) const
{
	...
	{
		case 1:
			//createProjectile(node, Projectile::Missile, 0.f, 1.5f, textures);
			createProjectile(node, type,  0.0f, 1.0f, textures);
			break;

		case 2:
			createProjectile(node, type, -0.1f, 0.4f, textures);
			createProjectile(node, type, +0.1f, 0.4f, textures);
			break;
	...
	/*
		case 4:
			createProjectile(node, type, -0.5f, 0.2f, textures);
			createProjectile(node, type, -0.4f, 0.3f, textures);
			createProjectile(node, type, -0.3f, 0.3f, textures);
			createProjectile(node, type, -0.2f, 0.4f, textures);
			createProjectile(node, type, -0.1f, 0.4f, textures);
			createProjectile(node, type,  0.0f, 0.5f, textures);
			createProjectile(node, type, +0.1f, 0.4f, textures);
			createProjectile(node, type, +0.2f, 0.4f, textures);
			...
			*/
		case 100: 
			createProjectile(node, Projectile::Laser, 0.0f, 0.5f, textures);
			//createProjectile(node, Projectile::Missile, 0.f, 0.5f, textures);
			break;
	}
}
