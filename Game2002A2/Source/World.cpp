...
void World::loadTextures()
{
	...
	mTextures.load(Textures::Laser, "Media/Textures/Laser.png");
}
...
void World::handleCollisions()
{
	...
	FOREACH(SceneNode::Pair pair, collisionPairs)
	{
		...
		else if (matchesCategories(pair, Category::PlayerAircraft, Category::EnemyAircraft))
		{
			auto& player = static_cast<Aircraft&>(*pair.first);
			...
			player.playLocalSound(mCommandQueue, SoundEffect::PlayerLooseLife);				//Player loosing health sound
...
void World::buildScene()
{
	...
	std::unique_ptr<Aircraft> player(new Aircraft(Aircraft::Eagle, mTextures, mFonts, 1));
	...
	/*if (States::Game)
		addEnemies();
	else if (States::Game2)
		addEnemies2();
	else if (States::Game3)
		addEnemies3();*/
...
void World::addEnemies2()
{
	// Add enemies to the spawn point container
	addEnemy(Aircraft::Raptor,  200.f,  500.f);
	addEnemy(Aircraft::Raptor,    0.f,  500.f);
	addEnemy(Aircraft::Raptor, -200.f,  500.f);
	addEnemy(Aircraft::Raptor,    0.f, 1000.f);
	addEnemy(Aircraft::Raptor, +100.f, 1150.f);
	addEnemy(Aircraft::Raptor, -100.f, 1150.f);
	addEnemy(Aircraft::Raptor, +300.f, 1150.f);
	addEnemy(Aircraft::Raptor, -300.f, 1150.f);
	addEnemy(Aircraft::Avenger,  70.f, 1500.f);
	addEnemy(Aircraft::Avenger, -70.f, 1500.f);
	addEnemy(Aircraft::Avenger, -70.f, 1710.f);
	addEnemy(Aircraft::Avenger,  70.f, 1700.f);
	addEnemy(Aircraft::Avenger,  30.f, 1850.f);
	addEnemy(Aircraft::Raptor,  100.f, 2200.f);
	addEnemy(Aircraft::Raptor, -100.f, 2200.f);
	addEnemy(Aircraft::Raptor,  300.f, 2200.f);
	addEnemy(Aircraft::Raptor, -300.f, 2200.f);
	addEnemy(Aircraft::Raptor,    0.f, 2200.f);
	addEnemy(Aircraft::Raptor,    0.f, 2500.f);
	addEnemy(Aircraft::Raptor,  200.f, 2200.f);
	addEnemy(Aircraft::Raptor,  200.f, 2500.f);
	addEnemy(Aircraft::Avenger,-300.f, 2700.f);
	addEnemy(Aircraft::Avenger,-300.f, 2700.f);
	addEnemy(Aircraft::Raptor,    0.f, 3000.f);
	addEnemy(Aircraft::Raptor,  250.f, 3250.f);
	addEnemy(Aircraft::Raptor, -250.f, 3250.f);
	addEnemy(Aircraft::Raptor,  400.f, 3250.f);
	addEnemy(Aircraft::Raptor, -400.f, 3250.f);
	addEnemy(Aircraft::Avenger,   0.f, 3500.f);
	addEnemy(Aircraft::Avenger,   0.f, 3700.f);
	addEnemy(Aircraft::Raptor,    0.f, 3800.f);
	...
	addEnemy(Aircraft::Raptor,  200.f, 4200.f);
	addEnemy(Aircraft::Raptor,    0.f, 4400.f);
	addEnemy(Aircraft::Raptor, -100.f, 4400.f);
	addEnemy(Aircraft::Raptor,  100.f, 4400.f);
...
void World::addEnemies3()
{
	...
	addEnemy(Aircraft::Avenger,  70.f, 1500.f);
	addEnemy(Aircraft::Avenger, -70.f, 1500.f);
	addEnemy(Aircraft::Avenger,-140.f, 1710.f);
	...
	addEnemy(Aircraft::Avenger, 400.f, 2700.f);
	addEnemy(Aircraft::Avenger,-400.f, 2700.f);
	addEnemy(Aircraft::Avenger, 200.f, 2700.f);
	addEnemy(Aircraft::Avenger,-200.f, 2700.f);
	addEnemy(Aircraft::Avenger,  50.f, 2700.f);
	addEnemy(Aircraft::Avenger, -50.f, 2700.f);

	addEnemy(Aircraft::Raptor,    0.f, 3000.f);

	addEnemy(Aircraft::Raptor,  150.f, 3250.f);
	addEnemy(Aircraft::Raptor, -150.f, 3250.f);
	addEnemy(Aircraft::Raptor,  250.f, 3250.f);
	addEnemy(Aircraft::Raptor, -250.f, 3250.f);
	addEnemy(Aircraft::Raptor,  400.f, 3250.f);
	...
	addEnemy(Aircraft::Avenger,   0.f, 3500.f);
	addEnemy(Aircraft::Avenger,   0.f, 3700.f);
	addEnemy(Aircraft::Avenger,-100.f, 3500.f);
	addEnemy(Aircraft::Avenger, 100.f, 3700.f);
	addEnemy(Aircraft::Avenger,-300.f, 3500.f);
	addEnemy(Aircraft::Avenger, 300.f, 3700.f);
	addEnemy(Aircraft::Raptor,    0.f, 3800.f);

	addEnemy(Aircraft::Raptor,    0.f, 4300.f);

	addEnemy(Aircraft::Raptor,    0.f, 4300.f);
	addEnemy(Aircraft::Raptor, -100.f, 4300.f);
	addEnemy(Aircraft::Raptor,  100.f, 4300.f);
	addEnemy(Aircraft::Raptor, -200.f, 4300.f);
	addEnemy(Aircraft::Raptor,  200.f, 4300.f);
	addEnemy(Aircraft::Raptor, -300.f, 4300.f);
	addEnemy(Aircraft::Raptor,  300.f, 4300.f);
	addEnemy(Aircraft::Raptor, -400.f, 4300.f);
	addEnemy(Aircraft::Raptor,  400.f, 4300.f);

	addEnemy(Aircraft::Avenger, -50.f, 4400.f);
	addEnemy(Aircraft::Avenger,  50.f, 4400.f);
	addEnemy(Aircraft::Avenger,-150.f, 4400.f);
	addEnemy(Aircraft::Avenger, 150.f, 4400.f);
	addEnemy(Aircraft::Avenger,-250.f, 4400.f);
	addEnemy(Aircraft::Avenger, 250.f, 4400.f);
	addEnemy(Aircraft::Avenger,-350.f, 4400.f);
	addEnemy(Aircraft::Avenger, 350.f, 4400.f);
...
void World::spawnEnemies()
{
		...
		&& mEnemySpawnPoints.back().y > getBattlefieldBounds().top)
	{
		...
		std::unique_ptr<Aircraft> enemy(new Aircraft(spawn.type, mTextures, mFonts, 1));
