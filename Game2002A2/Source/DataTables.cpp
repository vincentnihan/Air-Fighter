...
std::vector<AircraftData> initializeAircraftData()
{
	...
	data[Aircraft::Eagle].hitpoints = 500;
	data[Aircraft::Eagle].speed = 200.f;
	data[Aircraft::Eagle].fireInterval = sf::seconds(1.0);
	...
	data[Aircraft::Raptor].hitpoints = 350;
	data[Aircraft::Raptor].speed = 80.f;
	data[Aircraft::Raptor].texture = Textures::Entities;
	data[Aircraft::Raptor].textureRect = sf::IntRect(144, 0, 84, 64);
	data[Aircraft::Raptor].directions.push_back(Direction(+200.f, 50.f));
	data[Aircraft::Raptor].directions.push_back(Direction(-45.f, 200.f));
	data[Aircraft::Raptor].directions.push_back(Direction(+200.f, 50.f));
	data[Aircraft::Raptor].hasRollAnimation = false;

	data[Aircraft::Avenger].hitpoints = 500;
	data[Aircraft::Avenger].speed = 50.f;
	data[Aircraft::Avenger].texture = Textures::Entities;
	data[Aircraft::Avenger].textureRect = sf::IntRect(228, 0, 60, 59);
	data[Aircraft::Avenger].directions.push_back(Direction(+200.f,  100.f));
	data[Aircraft::Avenger].directions.push_back(Direction(  0.f,  100.f));
	data[Aircraft::Avenger].directions.push_back(Direction(-200.f, 200.f));
	data[Aircraft::Avenger].directions.push_back(Direction(  0.f,  100.f));
	data[Aircraft::Avenger].directions.push_back(Direction(+200.f,  100.f));
...
std::vector<ProjectileData> initializeProjectileData()
{
	...
	data[Projectile::AlliedBullet].damage = 45;
	...
	data[Projectile::EnemyBullet].damage = 17;
